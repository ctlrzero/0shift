export default function Services() {
  const services = [
    ...
    },
    {
      ...
      paths: [
        "M12 4.354a4 4 0 110 5.292M15 10H9m6 0a9 9 0 11-18 0 9 9 0 0118 0z",
        "M17 9l-5 5m0 0l-5-5m5 5v6",
      ],
      color: "from-primary to-primary",
      features: [
        "Skilled developers",
    ...
    },
    {
      ...
      paths: [
        "M9 12l2 2 4-4M7 20H5a2 2 0 01-2-2V7a2 2 0 012-2h4a2 2 0 012 2v11m0 0V9a2 2 0 012-2h4a2 2 0 012 2v11a2 2 0 01-2 2h-4a2 2 0 01-2-2z",
      ],
      color: "from-primary to-primary",
      features: [
              ...
              >
                ...
                <div className="relative">
                  <div className="mb-6 flex items-center justify-between">
                    <div
                      className={`flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary/80 p-0.5 transition-transform duration-300 group-hover:scale-110 shadow-lg`}
                    >
                    ...
                    <div className="text-6xl font-bold text-slate-100 group-hover:text-primary/20 transition-colors select-none">
                      {s.n}
                    </div>
                  </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-primary/90 px-8 py-20 text-center shadow-2xl">
            ...
            <div className="relative">
              ...
              <p className="mx-auto max-w-2xl text-lg text-white/90 mb-10">
                Let's discuss how our services can drive measurable results for
                your organization.
              </p>
